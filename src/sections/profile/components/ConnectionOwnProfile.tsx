...
import { Avatar, Button, CircularProgress, Grid, Stack, styled, Typography, useTheme } from '@mui/material';
          ...
          <>
            {followerCount > 0 ? (
              <>
                ...
                <Stack sx={{ pt: 3, pb: 0 }}>
                  <Button
                    onClick={() => router.push('/connections/followers')}
                    size="small"
                    variant="outlined"
                    sx={{
          ...
          <>
            {followingCount > 0 ? (
              <>
                ...
                <Stack sx={{ pt: 3, pb: 2 }}>
                  <Button
                    onClick={() => router.push('/connections/following')}
                    size="small"
                    variant="outlined"
                    sx={{
                      borderColor: (theme) => theme.palette.text.secondary,
            ...
            <>
              {requestCount > 0 ? (
                <>
                  ...
                  <Stack sx={{ pt: 3, pb: 2 }}>
                    <Button
                      onClick={() => router.push('/connections/request')}
                      size="small"
                      variant="outlined"
                      sx={{
                        borderColor: (theme) => theme.palette.text.secondary,
          ...
          <>
            {requestedCount > 0 ? (
              <>
                ...
                <Stack sx={{ pt: 3, pb: 2 }}>
                  <Button
                    onClick={() => router.push('/connections/requested')}
                    size="small"
                    variant="outlined"
                    sx={{
                      borderColor: (theme) => theme.palette.text.secondary,
