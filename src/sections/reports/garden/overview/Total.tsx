...
import { useLazyGetCampaignsRecentInfoQuery } from 'src/_requests/graphql/history/queries/getCampaignsRecentInfo.generated';
...
function Total() {
  ...
  return (
    <Stack spacing={2}>
      <Stack p={2} spacing={2}>
        <Typography>Total - Recent 30 days </Typography>
