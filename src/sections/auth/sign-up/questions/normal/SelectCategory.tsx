...
import { useUpsertInterestedCategoriesMutation } from 'src/_requests/graphql/profile/ngoPublicDetails/mutations/upsertIntrestedCategories.generated';
...
export default function SelectCategory(props: SelectCategoryProps) {
  ...
  return (
    <>
      <Dialog fullWidth={true} open={openCategoryDialog}>
        <DialogTitle>
          <DialogIconButtons router={router} user={user} setOpenStatusDialog={setOpenCategoryDialog} hasBackIcon />
