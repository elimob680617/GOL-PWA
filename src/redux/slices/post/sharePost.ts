...
// types
import {  ISharePost } from 'src/@types/post';
...
// Actions
export const { setSharedPostId, setSharePostId ,setPostType, setCurrentPosition, setSharedPostType , setSharedPostAudience, setSharedPostEditMode,setSharedPostMediaUrls , setSharedPostLocation,  setSharedPostText, valuingAll, resetSharedPost  } =
  slice.actions;
