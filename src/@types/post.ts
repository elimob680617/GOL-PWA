...
import { Audience, Category, DeadlineEnum, MediaUrlInputType, PostStatus, UserTypeEnum } from './sections/serverTypes';
...
export interface ISearchedHashtag {
  id?: string | null;
  title?: string | null;
}
...
export interface ISearchedPost {
  ...
  mentionedUserIds?: Array<string | null> | null;
  pictureUrls?: Array<string | null> | null;
